...
- [x] Clarify Project Requirements - User requested a sample Java project with Maven.

- [x] Scaffold the Project - Created Maven project structure with pom.xml, App.java, and README.md.

- [x] Customize the Project - Skipped for "Hello World" project.

- [x] Install Required Extensions - No extensions needed.

- [x] Compile the Project - Compiled successfully with Maven.

- [x] Create and Run Task - Created build task; build works.
